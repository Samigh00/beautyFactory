<?php
include '../../../controller/nouveautesC.php';
...
$nouv->delete();
if(isset($_GET['sort'])){
	$news=$nouv->sortby();}else if(isset($_GET['search'])){
	$news=$nouv->search();}else{$news=$nouv->read();}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    <li class="btn-group d-lg-inline-flex d-none">
                        <div class="app-menu">
							...
							<form class="ml-auto search-form d-none d-md-block" action="list.php?search=">
  ...
  <div class="content-wrapper">
	  <div class="container-full">
		...
		<thead>
			<tr>
			<th scope="col"><a href="list.php?sort=id">#</a></th>
			<th scope="col"><a href="list.php?sort=titre">Titre</a></th>
			<th scope="col">text</th>
			<th scope="col">photo</th>
			<th scope="col"><a href="list.php?sort=date">date</a></th>
		...
		<?php foreach ($news as $n) : ?>
			...
			<td><?=$n['titre']?></td>
			<td><?=$n['text']?></td>
			<td><img src="<?=$n['photo']?>" height="100px"  width="100px"></td>
			<td><?=$n['date']?></td>
			<?php $c=gets ($n['id']);
			error_reporting(E_ERROR | E_PARSE);
			if(!$c){
				echo "<td></td>";
				echo '<td><a href="list.php?delete=';echo $n['id'] ; echo '">delete</a>/<a href="edit.php?id=';echo $n['id']; echo '">update</a>/<a href="Addcategorie.php?id='; echo $n['id']; echo '">ajouter categorie</a></td>';
			}else{
				echo "<td>";echo $c['nom'];echo "</td>";
				echo '<td><a href="list.php?delete=';echo $n['id'] ; echo '">delete</a>/<a href="edit.php?id=';echo $n['id']; echo '">update</a>/<a href="editcategorie.php?id='; echo $n['id']; echo '">modifier categorie</a> / <a href="list.php?deletec=';echo $c['id'] ; echo ' ">supprimer categorie</a></td> ';
			}
			?>
		</tr>
			<?php endforeach ?>
		...
		<a href="Addnews.php" class="btn-primary">Add news</a>
		</section>
