...
<div class="wrapper">
    ...
    <div class="content-wrapper">
		...
		<section class="content">
			<div class="row">
			  <div class="col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<form action="Addnews.php?ajout" method="post" class="forms-sample" id="ajout" >
						<div class="form-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label class="fw-700 fs-16 form-label">New Title</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea name="text" class="form-control" id="descin" cols="30" rows="10"></textarea>
										<span id="ee"></span>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="fw-700 fs-16 form-label">Picture</label>
										<input type="text" name="photo" id="photo" class="form-control" placeholder="pic link ...">
										<span id="eee"></span>
									</div>
								</div>
							</div>
					...
					<script>
						let myform =document.getElementById('ajout');
						myform.addEventListener('submit',function(e){
							let tinput = document.getElementById('title');
							let desc = document.getElementById('descin');
							let pic = document.getElementById('photo');
							const regex = /^[a-zA-Z-\s]+$/;
							if(tinput.value === '' ){
								let nameer = document.getElementById('e');
								nameer.innerHTML="le champs titre est vide . ";
								nameer.style.color ='red';
								e.preventDefault();
							}else if (!(regex.test(tinput.value))){
								let nameer = document.getElementById('e');
								nameer.innerHTML = "le titre doit comporter des lettres,et tirets seulements.";
								nameer.style.color='red';
								e.preventDefault();
							}
							if(desc.value === '' ){
								let teler = document.getElementById('ee');
								teler.innerHTML="le champs description est vide . ";
								teler.style.color ='red';
								e.preventDefault();
							}
							if(pic.value === '' ){
								let suber = document.getElementById('eee');
								suber.innerHTML="le champs photo est vide . ";
		  ...
		  <a href="list.php" class="btn-primary">news list</a>
		</section>
