			...
			<div class="row">
			  <div class="col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<form action="edit.php?update=<?=$n['id']?>" method="post" class="forms-sample" >
						<div class="form-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label class="fw-700 fs-16 form-label">New Title</label>
									  <input type="text" name="title" class="form-control" placeholder="title ..." value="<?=$n['titre']?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea name="text" class="form-control" id="" cols="30" rows="10"><?=$n['text']?></textarea>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="photo" class="form-control" placeholder="pic link ..." value="<?=$n['photo']?>">
									</div>
								</div>
							</div>
						</div>
