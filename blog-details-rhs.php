...
<div class="wrapper"><!-- Wrapper -->
    <div class="inner-wrapper"><!-- Inner-Wrapper -->
    	<div class="top-bar"><!-- Top Bar -->
        	<div class="container">
            	<p>ipsum dolor sLorem it amet consectetur</p>
                <div class="top-right">
                	<ul>
                        <li>
                	...
                	<article class="blog-post blog-single-entry ">	
                        ...
                        <div class="entry-details">
                            ...
                            <div class="entry-metadata">
                                ...
                                <div class="date">
                                    <a href="#" title="Comment on Latin words Ipsum"> <span class="fa fa-clock-o"> </span><?=$n['date']?></a>
                                </div> 
                                <div class="likes">
                            ...
                            <div class="commententries">
                            	<h3 class="border-title"><span>Comments</span></h3>
                                <ul class="commentlist">
                                        <?php $comment=getcom($n['id']); ?>
                                        <?php foreach ($comment as $com) : ?>
                                            <li>
                                        <div class="comment">
                                            <div class="comment-details">
                                                <div class="author-name">
                                                    <a href="" title=""><?=$com['nom']?> </a>
                                                </div>
                            ...
                            <div id="respond">
                                ...
                                <form method="post" action="blog-details-rhs.php?comment" name="enqform" id="comment-form" novalidate>
                                	<div class="animate" data-delay="100" data-animation="fadeIn">
                                        <div class="column dt-sc-one-third first">
                                            <p>
                                                <input type="text" name="nom" title="Please enter your name" placeholder="Name" >
                                            </p>
                                        </div>
                                    </div>
                                    <input type="number" value="<?=$n['id']?>" name="id" hidden>
                                    <div class="clear"></div>
                                    <div class="animate" data-delay="700" data-animation="fadeIn">
                                    	<div class="column dt-sc-one-column">
                                            <p>
                                                <textarea cols="5" rows="10"  name="txt" class="message" placeholder="Your Message"></textarea>
                                            </p>
                ...
                <section id="secondary" class="secondary-right-sidebar">
                    ...
                    <h3 class="border-title"> Blog <span>Search</span></h3>
                    	<form method="post" action="#" name="searchform" class="subscribe-frm">
                            <p>
                            	<input type="text" name="username" placeholder="Enter Keyword" >                              
                    ...
                    <div class="column dt-sc-one-fourth">
                    	<aside class="widget widget_newsletter">
                            ...
                            <form class="subscribe-frm" method="post" name="frmnewsletter" action="php/subscribe.php">
                                <input type="email" placeholder="Enter email ID"  value="" name="mc_email" >
