...
<!-- Mirrored from buddhathemes.com/html/trendsalon/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Apr 2022 01:41:58 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="wrapper"><!-- Wrapper -->
    <div class="inner-wrapper"><!-- Inner-Wrapper -->
        ...
        <header id="header" class="dt-sticky-menu type2"><!-- Header -->
            <div id="logo"><!-- Logo -->
                <a title="TrendSalon" href="index.html"><img title="TrendSalon" alt="Trendy" src="../assets/images/logo.png"></a>
            </div><!-- End of Logo -->
            <div id="menu-container">
                <div class="container">
                    <nav id="main-menu"><!-- Nav - Starts -->
                        ...
                        <a title="TrendSalon" href="index.html" class="sticky-logo"><img title="TrendSalon" alt="Trendy" src="../assets/images/logo.png"></a>
                        <ul class="menu">
