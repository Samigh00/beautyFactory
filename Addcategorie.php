			...
			<div class="row">
			  <div class="col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<form action="addcategorie.php?ajout" method="post" id="ajout" class="forms-sample" >
						<div class="form-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label class="fw-700 fs-16 form-label">Category</label>
									  <input type="text" name="categorie" id="cat" class="form-control" placeholder="categorie ...">
                                      <span id="adder"></span>
									</div>
								</div>
							</div>
                    ...
                    <script>
						...
						myform.addEventListener('submit',function(e){
							let nameinput = document.getElementById('cat');
							const regex = /^[a-zA-Z-\s]+$/;
							if(nameinput.value === '' ){
								let nameer = document.getElementById('adder');
